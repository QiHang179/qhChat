    ...
    , ui(new Ui::RegisterDialog),_countdown(5)
{
    ...
    ui->cfpwd_edit->setEchoMode(QLineEdit::Password);
    ...
    connect(ui->cfpwd_edit, &QLineEdit::editingFinished, this, [this](){
        checkConfirmValid();
    });
    ...
    connect(ui->confirm_visible, &ClickedLabel::clicked, this, [this]() {
        ...
        if(state == ClickLbState::Normal){
            ...
            ui->cfpwd_edit->setEchoMode(QLineEdit::Normal);
        }
        qDebug() << "Label was clicked!";
    });
...
bool RegisterDialog::checkPassValid()
{
    ...
    auto confirm = ui->cfpwd_edit->text();
...
void RegisterDialog::on_sure_btn_clicked()
{
    ...
    json_obj["confirm"] = xorString(ui->cfpwd_edit->text());
